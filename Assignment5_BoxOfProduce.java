...
public class Assignment5_BoxOfProduce {
	...
	public Assignment5_BoxOfProduce() { //constructor method
		item1="";
		item2="";
		item3="";
	} 
	
	public Assignment5_BoxOfProduce(String pOne) { //constructor overloading
		item1=pOne;
		item2="";
		item3="";
	} 

	public Assignment5_BoxOfProduce(String pOne, String pTwo) { //constructor overloading
		item1=pOne;
		item2=pTwo;
		item3="";
	} 

	public Assignment5_BoxOfProduce(String pOne, String pTwo, String pThree) { //constructor overloading
		item1=pOne;
		item2=pTwo;
		item3=pThree;
	} 
