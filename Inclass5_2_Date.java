public class Inclass5_2_Date{
	private int day, year; //initialize
	private String month; //initialize

	public Inclass5_2_Date() { //constructor
		month=" ";
		day=0;
		year=0;
	}

	public Inclass5_2_Date(String m, int d, int y) { //constructor overloading; accepts initial inputs
		month=m;
		day=d;
		year=y;
	}
