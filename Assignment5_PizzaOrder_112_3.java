public class Assignment5_PizzaOrder_112_3 {
	//private char size;
	...
	public Assignment5_PizzaOrder_112_3(){ //constructor
		numPizzas = 0;
		pizza1Cost = 0;
		pizza2Cost = 0;
		pizza3Cost = 0;
	...
	public void setPizza1(Assignment5_Pizza_112_3 pizza1) {
		if (numPizzas >= 1) {
			pizza1Cost = pizza1.calcCost();
		}
	}

	public void setPizza2(Assignment5_Pizza_112_3 pizza2) {
		if (numPizzas >= 2) {
			pizza2Cost = pizza2.calcCost();
		}
	}

	public void setPizza3(Assignment5_Pizza_112_3 pizza3) {
		if (numPizzas >= 3) {
...
*/
	...
	/*public void Assignment5_Pizza_112_3() { //constructor
		size = 'S';
		num_cheese = 0; 
		num_pepperoni = 0;
		num_ham = 0;
	...
	public void Assignment5_Pizza_112_3(char s) { //constructor overloading
		size = s;
		num_cheese = 0; 
		num_pepperoni = 0;
		num_ham = 0;
	...
	public void Assignment5_Pizza_112_3(char s, int num_ch) { //constructor overloading
		size = s;
		num_cheese = num_ch; 
		num_pepperoni = 0;
		num_ham = 0;
	...
	public void Assignment5_Pizza_112_3(char s, int num_ch, int num_pep) { //constructor overloading
		size = s;
		num_cheese = num_ch; 
	...
	public void Assignment5_Pizza_112_3(char s, int num_ch, int num_pep, int num_hm) { //constructor overloading
		size = s;
		num_cheese = num_ch; 
		num_pepperoni = num_pep;
		num_ham = num_hm;
