...
public class BlogEntry_demo { //create demo class
	public static void main(String [] args) { //define the main
		...
		BlogEntry entry = new BlogEntry(username, m, d, y, text); //invoke constructor from BlogEntry class; allocates memory for the instance variables of BlogEntry class; "entry" points to this object in memory
